...
export const GoldenRatioSidebar: React.FC<{ slots: Record<string, any> }> = ({ slots }) => {
  return (
    <div style={{
      ...
      <h1 style={{ ...aisTokens.typography.title, color: aisTokens.colors.primary, textShadow: aisTokens.effects.glowStrong }}>
        {slots.title || slots.eyebrow || slots.quote || slots.wrong || slots.action || "GoldenRatioSidebar"}
      </h1>
